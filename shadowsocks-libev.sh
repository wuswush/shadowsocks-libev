...
get_latest_version(){
    ...
    init_script_link="https://raw.githubusercontent.com/yagelseneburayaoc/shadowsocks-libev/master/shadowsocks-libev"
}
...
pre_install(){
    ...
    read -p "(Default password: Shadowsocks123):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="Shadowsocks123"
    echo
    echo "---------------------------"
